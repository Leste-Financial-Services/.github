# 📁 Ownership (Propriedade & Responsabilidade)

Define a quem pertencem os recursos e quem responde por eles.
...
- **Dependências Externas**: Devem ser aprovadas antes da inclusão no projeto para evitar conflitos de licenciamento ou segurança.

## 3. Dados
- Propriedade dos dados de acordo com a unidade de negócio (Risk, Finance, Ops).
